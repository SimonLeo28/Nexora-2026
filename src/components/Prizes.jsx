...
export default function Prizes() {
    const prizes = [
        { place: "Winner", amount: "₹15,000", perks: "Cash + Certificates + Recognition" },
        { place: "1st Runner-up", amount: "₹10,000", perks: "Cash + Certificates + Recognition" },
        { place: "2nd Runner-up", amount: "₹5,000", perks: "Cash + Certificates + Recognition" },
    ];
